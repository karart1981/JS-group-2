"use strict";
//string-ը ունի միայն մեկ property` length
...
/* 1. Math.round */  console.log(Math.round(someNum)); /* մաթեմատիկայի օրենքների 
նման,եթե 1,4 - կլորացնում է դեպի ներքև, եթե 1,5 կամ 1,6 կամ ավել կլորացնում է 
դեպի վերև */
/* 2. Math.ceil */  console.log(Math.ceil(someNum)); // կլորացնում է դեպի վերև
/* 3. Math.floor */  console.log(Math.floor(someNum)); // կլորացնում է դեպի ներքև
