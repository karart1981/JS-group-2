...
const app = {
	...
	callCenter(address, telNumber, isDelivery, isOpen, type, timeWork) {
		if(timeWork = !app.restaurantDetails[7].isOpen === true) {
			console.log("Կներեք մենք այս ժամին չենք աշխատում։");
		}else{ return `
...
let time = 25;
let beerQuantity = 0;
console.log(app.callCenter(timeWork(24,24)));
